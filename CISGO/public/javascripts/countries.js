    ...
    //countryData.forEach(myFunction);
    // loop through the country data and create map points for each
...
function retrieveCountries() {
    ...
    // function to find a country's coordinates by its name
    function findCoordsByName(countryName) {
        ...
        var country = [countryName, LatX, LonX];
        console.log("Name Passed: "+ countryName + " || Lat: " + country[1] + " || Lon: " + country[2]);
        return country;
    }
